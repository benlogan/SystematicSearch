...
url = "https://dblp.org/search/publ/api?q=(sustainab*%20%7C%20green%24%20%7C%20energy%24)%20(software%24%20%7C%20%20IT%24%20%20%7C%20computing%24%20%7C%20cloud%24)%20year%3A1995%3A&format=bib1&rd=1a"
...
while year <= 2023:
    ...
    url += str(year) + "%3A&format=bib1&rd=1a"
    print(url)
